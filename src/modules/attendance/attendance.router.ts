...
attendanceRouter.post(
  ...
  asyncHandler(async (req, res) => {
    ...
    res.json(await attendanceService.checkIn(req.auth.userId, req.body as PunchBody, req.auth.userId));
  }),
);
...
attendanceRouter.post(
  ...
  asyncHandler(async (req, res) => {
    if (!req.auth) throw Unauthorized();
    res.json(await attendanceService.checkOut(req.auth.userId, req.body as PunchBody, req.auth.userId));
  }),
);
